...
- ``PCCP 2018`` **Quan S**, He L, Ni Y. [Tunable mosaic structures in van der Waals layered materials](https://pubs.rsc.org/en/content/articlelanding/2018/cp/c8cp04360d/unauth)[J]. Physical Chemistry Chemical Physics, 2018, 20(39): 25428-25436. <strong><span class='show_paper_citations' data='lWWgucAAAAAJ:W7OEmFMy1HYC'></span></strong>
...
- ``RP 2023`` **Quan S**, Zhang Y, Lin P. [Fatigue damage quantitative evaluation of carbon fiber composites at different stress ratios based on nonlinear ultrasonic](https://www.sciencedirect.com/science/article/pii/S2211379723004886)[J]. Results in Physics, 2023, 51: 106695. <strong><span class='show_paper_citations' data='lWWgucAAAAAJ:hqOjcs7Dif8C'></span></strong>
...
- ``Langmuir 2024`` **Quan S**, Zhang Y, Liu H, et al. [Strain effects in the work function and charge transfer of the Au (111) surface](https://pubs.acs.org/doi/abs/10.1021/acs.langmuir.4c01408)[J]. Langmuir, 2024, 40(32): 16867-16874. <strong><span class='show_paper_citations' data='lWWgucAAAAAJ:kNdYIx-mwKoC'></span></strong>
- ``JMEP 2024`` **Quan S**, Zhang Y, Lin P. [Bolt axial stress detection and prediction based on the nonlinear ultrasonic technique](https://link.springer.com/article/10.1007/s11665-023-08706-7)[J]. Journal of Materials Engineering and Performance, 2024, 33(20): 10681-10688.<strong><span class='show_paper_citations' data='lWWgucAAAAAJ:5nxA0vEk-isC'></span></strong>
